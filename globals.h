...
const char elements[12] = {'*', 'S', 's', 'J', 'B', 'F', 'j', 'T', 'C', 'Z', 'z', 'A'};
...
char LEVEL_10_DATA[] {
    ...
    '#', ' ', ' ', ' ', ' ', ' ', '#', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', '#', '#', '#', '#', '#',
    '#', '@', ' ', ' ', 'J', ' ', '#', 'z', 'z', 'z', 'S', 'z', 'z', 'z', 'S', 'z', 'z', 'S', 'z', 'z', 'S', 'z', 'z', 'z', '#', '#', '#', '#', '#',
    '#', '#', '#', '#', '#', '#', '#', '#', '#', '#', '#', '#', '#', '#', '#', '#', '#', '#', '#', '#', '#', '#', '#', '#', '#', '#', '#', '#', '#',
};
...
bool completed_levels[LEVEL_COUNT] = {false,false,false,false,false,false,false,false,false,false};
...
bool is_player_has_sword = false;
